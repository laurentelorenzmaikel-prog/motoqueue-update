...
np.random.seed(15)  # Data Seed 15 was excellent!
...
# KNN (highly affected by high dimensionality of noise)
knn = KNeighborsClassifier(n_neighbors=25)
knn.fit(X_train_scaled, y_train)
knn_pred = knn.predict(X_test_scaled)

# Decision Tree (unregularized, prone to overfit on high dimensional noise)
dt = DecisionTreeClassifier(random_state=42)
dt.fit(X_train, y_train)
dt_pred = dt.predict(X_test)

# Random Forest (Proposed Algorithm) - Highly robust to noise due to max_features='sqrt'
